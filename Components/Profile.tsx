...
function Profile() {
  ...
  return (
    <Flex direction={isNotSmallerScreen ? 'row' : 'column'} w="100%" maxWidth={{ base: '90vh', md: '130vh', lg: '130vh', xl: '130vh' }}>
      <Box alignSelf="center" px="32" py="16">
        <Heading fontWeight="extrabold" color="cyan.500" size="xl">
          Finding For Internship
        </Heading>
      </Box>
      <Box alignSelf="center" px="32" py="16">
        <Text fontWeight="bold" fontSize="2xl">
          Specialize At Web Developer Using React and Next.Js
        </Text>
